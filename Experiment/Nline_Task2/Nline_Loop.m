...
try
    ...
    if pract == '1';
        ...
        prac3 = [80 0.8];
        prac4 = [35 0.35];
        [block_p_points, p_move, p_slow, p_wrong, p_badpress] = Practice_TrialLoop(prac1,block_p_points,p.decision,left_end,right_end,lineLength,lineSZ,jitter,p.ppc_adjust,win,color,x1,x2,yline,center,winRect,3,3.5,0,task,p_move,p_slow,p_wrong,p_badpress,p.speed);
        [block_p_points, p_move, p_slow, p_wrong, p_badpress] = Practice_TrialLoop(prac2,block_p_points,p.decision,left_end,right_end,lineLength,lineSZ,jitter,p.ppc_adjust,win,color,x1,x2,yline,center,winRect,4,3,1,task,p_move,p_slow,p_wrong,p_badpress,p.speed);
        [block_p_points, p_move, p_slow, p_wrong, p_badpress] = Practice_TrialLoop(prac3,block_p_points,p.decision,left_end,right_end,lineLength,lineSZ,jitter,p.ppc_adjust,win,color,x1,x2,yline,center,winRect,1,4,0,task,p_move,p_slow,p_wrong,p_badpress,p.speed);
        [block_p_points, p_move, p_slow, p_wrong, p_badpress] = Practice_TrialLoop(prac4,block_p_points,p.decision,left_end,right_end,lineLength,lineSZ,jitter,p.ppc_adjust,win,color,x1,x2,yline,center,winRect,2,3.5,1,task,p_move,p_slow,p_wrong,p_badpress,p.speed);
        ...
        [block_p_points, p_move, p_slow, p_wrong, p_badpress] = Practice_TrialLoop(prac9,block_p_points,p.decision,left_end,right_end,lineLength,lineSZ,jitter,p.ppc_adjust,win,color,x1,x2,yline,center,winRect,2,2.5,1,task,p_move,p_slow,p_wrong,p_badpress,p.speed);
        [block_p_points, p_move, p_slow, p_wrong, p_badpress] = Practice_TrialLoop(prac10,block_p_points,p.decision,left_end,right_end,lineLength,lineSZ,jitter,p.ppc_adjust,win,color,x1,x2,yline,center,winRect,1.5,4,0,task,p_move,p_slow,p_wrong,p_badpress,p.speed);
