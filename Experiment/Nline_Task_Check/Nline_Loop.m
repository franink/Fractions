...
try
    ...
    if pract == '1';
        ...
        prac3 = [80 0.8];
        prac4 = [35 0.35];
        [block_p_points, p_move, p_slow, p_wrong, p_badpress] = Practice_TrialLoop(stim,block_p_points,p.decision,left_end,right_end,lineLength,lineSZ,jitter,ppc_adjust,win,color,x1,x2,yline,Center,winRect,3,3.5,0,task,p_move,p_slow,p_wrong,p_badpress,p.speed,p);
        [block_p_points, p_move, p_slow, p_wrong, p_badpress] = Practice_TrialLoop(stim,block_p_points,p.decision,left_end,right_end,lineLength,lineSZ,jitter,ppc_adjust,win,color,x1,x2,yline,Center,winRect,4,3,1,task,p_move,p_slow,p_wrong,p_badpress,p.speed,p);
        [block_p_points, p_move, p_slow, p_wrong, p_badpress] = Practice_TrialLoop(stim,block_p_points,p.decision,left_end,right_end,lineLength,lineSZ,jitter,ppc_adjust,win,color,x1,x2,yline,Center,winRect,1,4,0,task,p_move,p_slow,p_wrong,p_badpress,p.speed,p);
        [block_p_points, p_move, p_slow, p_wrong, p_badpress] = Practice_TrialLoop(stim,block_p_points,p.decision,left_end,right_end,lineLength,lineSZ,jitter,ppc_adjust,win,color,x1,x2,yline,Center,winRect,2,3.5,1,task,p_move,p_slow,p_wrong,p_badpress,p.speed,p);
