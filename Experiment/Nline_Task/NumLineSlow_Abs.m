function trialResponse = NumLineSlow_Abs(fract, win, lineLength, jitter, color, end_decision, ctch, points)
...
%Initialize log
trialResponse = {Num_probe Denom_probe probeMag correct response RT Error points mouse_pos};
