function [p, points, block_points] = Nline_Loop(filename, win, color, p, points, TestNline, block_points, lineLength, stim)
...
try
    ...
    if pract == '1';
        ...
        [block_p_points, p_move, p_slow, p_wrong, p_badpress] = Practice_TrialLoop(prac3,block_p_points,p.decision,left_end,right_end,lineLength,lineSZ,jitter,ppc_adjust,win,color,x1,x2,yline,Center,winRect,1,4,0,task,p_move,p_slow,p_wrong,p_badpress,p.speed);
        [block_p_points, p_move, p_slow, p_wrong, p_badpress] = Practice_TrialLoop(prac4,block_p_points,p.decision,left_end,right_end,lineLength,lineSZ,jitter,ppc_adjust,win,color,x1,x2,yline,Center,winRect,2,3.5,1,task,p_move,p_slow,p_wrong,p_badpress,p.speed);
        ...
        [block_p_points, p_move, p_slow, p_wrong, p_badpress] = Practice_TrialLoop(prac5,block_p_points,p.decision,left_end,right_end,lineLength,lineSZ,jitter,ppc_adjust,win,color,x1,x2,yline,Center,winRect,1.5,2.5,0,task,p_move,p_slow,p_wrong,p_badpress,p.speed);
        ...
        [block_p_points, p_move, p_slow, p_wrong, p_badpress] = Practice_TrialLoop(prac9,block_p_points,p.decision,left_end,right_end,lineLength,lineSZ,jitter,ppc_adjust,win,color,x1,x2,yline,Center,winRect,2,3.5,1,task,p_move,p_slow,p_wrong,p_badpress,p.speed);
        [block_p_points, p_move, p_slow, p_wrong, p_badpress] = Practice_TrialLoop(prac10,block_p_points,p.decision,left_end,right_end,lineLength,lineSZ,jitter,ppc_adjust,win,color,x1,x2,yline,Center,winRect,2.5,5.5,0,task,p_move,p_slow,p_wrong,p_badpress,p.speed);
        p_points = block_p_points + p_points;
        ...
        [block_p_points, p_move, p_slow, p_wrong, p_badpress] = Practice_TrialLoop(prac9,block_p_points,p.decision,left_end,right_end,lineLength,lineSZ,jitter,ppc_adjust,win,color,x1,x2,yline,Center,winRect,2,2.5,0,task,p_move,p_slow,p_wrong,p_badpress,p.speed);
        [block_p_points, p_move, p_slow, p_wrong, p_badpress] = Practice_TrialLoop(prac10,block_p_points,p.decision,left_end,right_end,lineLength,lineSZ,jitter,ppc_adjust,win,color,x1,x2,yline,Center,winRect,1.5,4,1,task,p_move,p_slow,p_wrong,p_badpress,p.speed);
        [block_p_points, p_move, p_slow, p_wrong, p_badpress] = Practice_TrialLoop(prac11,block_p_points,p.decision,left_end,right_end,lineLength,lineSZ,jitter,ppc_adjust,win,color,x1,x2,yline,Center,winRect,1,3.5,1,task,p_move,p_slow,p_wrong,p_badpress,p.speed);
        ...
        for ii = 1:(p.ntasks);
            ...
            for jj = 1:p.nStim;
                ...
                [p.NlineResults(trialNbr+1,28:32,kk), p.NlineResults(trialNbr+1,7:20,kk)] =...
                    TrialLoop(stim,points, left_end, right_end, lineLength,...
                    lineSZ, jitter, ppc_adjust, win, color, x1, x2, yline, Center, winRect, TestNline{trialNbr,3,kk},...
                    task, start_t, end_ITI, end_consider, end_hold, end_decision, move, slow, wrong, badpress,p.speed, p);
