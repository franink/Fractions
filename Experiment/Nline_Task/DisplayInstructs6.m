...
Instruct{1} = {'In the following trials you will be asked to mark a',
               ...
               ' ',
               'All trials have two phases. During the first phase, you will',
               ...
               'fixate your eyes on the dot and wait until it changes to GREEN.',
               'Only after the dot changes to GREEN, you should click',
               'the mouse and start moving the cursor to mark the line.',
               ' ',
               'Please CLICK MOUSE to go on to the next screen.'};
 
Instruct{2} = {'The beginning of each trial is similar to the previous tasks.',
                'You will see the line in the middle of the screen and',
                'after some time an empty box will appear above the line',
                ...
                'so make sure you keep your eyes fixated on the box above the line.',
                ' ',
                ...
                'on the RED dot until it turns GREEN. Once the dot turns GREEN you can',
         		'activate the cursor by clicking the mouse. At the same time, a word will appear',
                'below the line. You should then move the mouse to mark the line',
                'just above the word. If you move the mouse BEFORE the dot turns GREEN,',
                ...
                ' ',
        		'If your mark on the line is within 5% of the correct position signaled by the word',
