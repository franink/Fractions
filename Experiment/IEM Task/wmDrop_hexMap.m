...
%
% instead of same/different behavioral task, now a "which is closer"?
% behavioral task (white or black dot?) to be consistent w/ wmDrop.m

% TCS - 10/19/2014


% to distribute null trials:
% - break into n_nulls chunks
% - use each chunk, 2:end-1, put a null there
...
defAns = {'AI8B2','XXX','1',num2str(s),'1','0','0.4'};
