...
Instruct{1} = {'In the following trials you will be asked to',
               ...
               ' ',
               'If you detect a change of contrast press the RED button'
...
Instruct{2} = {'In order to do the task correctly you need to follow these instructions:',
                ...
                ' ',
                'Press the RED button quickly if you detect a change in the contrast of the',
                'flickering checkerboard. You will only have 1 second to press the RED button',
                ' ',
                'Please PRESS BUTTON to go on to the next screen.'};
...
Instruct{3} =  {'In the following screen you will see an example of',
               ...
               ' ',
               'Press the RED button when you detect the change in contrast',
               ' ',
               ' ',
